...
<div class="container w-75">
    ...
    <ul class="list-group">
        <c:forEach items="${groups}" var="group">
            <li class="list-group-item">${group.getName()} <a href="/admin/group/${group.getName()}"
                                                              class="badge btn btn-warning float-right">EDIT</a></li>
        </c:forEach>
    </ul>
    <h4>Users</h4>
    <ul class="list-group">
        <c:forEach items="${users}" var="usr">
            <li class="list-group-item">${usr.getName()} <a href="/admin/user/${usr.getName()}"
                                                            class="badge btn btn-warning float-right">EDIT</a></li>
        </c:forEach>
    </ul>
</div>
